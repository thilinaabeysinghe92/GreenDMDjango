...
$(function(){
	...
	myTestApp = jsCow.applications.add('myTestAppId').get();
		...
		win = jsCow.components.get(jsCow.res.components.window).setConfig({ title: 'Data Mining Model' }).setWidth(800).setHeight(600).setPos(10,10 );
		...
		tablewindow = jsCow.components.get(jsCow.res.components.window).setConfig({ title: 'Data Mining Model' }).setWidth(800).setHeight(600).setPos(10,10 );
